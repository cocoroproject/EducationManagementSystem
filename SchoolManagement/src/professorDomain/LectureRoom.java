...
public class LectureRoom {
	...
	private String lectureRoom_capacity;
	...
	public LectureRoom(int lectureRoom_number, String lectureRoom_name, 
							String lectureRoom_capacity, String lectureRoom_address) {
	...
	public String getLectureRoom_capacity() {
		return lectureRoom_capacity;
	}

	public void setLectureRoom_capacity(String lectureRoom_capacity) {
		this.lectureRoom_capacity = lectureRoom_capacity;
	}
