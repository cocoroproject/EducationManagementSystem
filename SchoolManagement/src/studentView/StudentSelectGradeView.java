...
public class StudentSelectGradeView {
	...
	public void outputSelectOneSemesterGrade(ArrayList<GradeSheet> selectedSemesterGrade) {
		...
		double convertScore = 0.0;                             // 평점평균합계
		System.out.println("");
		System.out.println("과목명\t\t학점단위\t총점\t학점");
		...
		System.out.println("");
		System.out.println("신청학점: "+registerGrade+ "\t\t이수학점: "+completeGrade+"\t\t평점평균: "+ (double)(Math.round((convertScore/selectedSemesterGrade.size())*100))/100);
		System.out.println("");
	}
